// Keep these protocol-facing types aligned with @tensnap/core while @tensnap/js publishes as a self-contained package.
...
export type ProtocolMessageType =
  | SimulatorToRendererMessageType
  | RendererToSimulatorMessageType;
...
export type SimulatorToRendererWSMessage =
  SimulatorToRendererMessage<SimulatorToRendererPayload>;
export type RendererToSimulatorWSMessage =
  RendererToSimulatorMessage<RendererToSimulatorPayload>;
export type AnyProtocolMessage =
  | SimulatorToRendererWSMessage
  | RendererToSimulatorWSMessage;
